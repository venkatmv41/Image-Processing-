...
% first = imread("1_SnowPoolsBefore_20180113_md-2048px.jpg");
% second = imread("2_SnowPoolsAfter_20200119_md-2048px.jpg");
% 
% firstimg = createMask(first);
% secondimg = createMask(second);
% montage({firstimg, secondimg});